...
func (ng *AlertNG) init() error {
	...
	// External Mimir/Cortex ruler sync worker. Routes the ruler config GET through
	// the datasource proxy service (same transport, auth and egress validation as
	// the user-driven proxy) and is gated at runtime by the
	// alerting.syncExternalRuler feature flag.
